...
export default function ManageFlights(){
  const { rows, loading, error, form, onChange, create, update, remove } = useCrud('/flights')
    ...
    <div>
      ...
      <div className="card mt-16">
        <table className="table">
          <thead><tr><th className="th">ID</th><th className="th">Flight</th><th className="th">From</th><th className="th">To</th><th className="th">Gate</th><th className="th">Time</th><th className="th">Actions</th></tr></thead>
          <tbody>
            {rows.map(r => (
              <tr key={r.id}>
